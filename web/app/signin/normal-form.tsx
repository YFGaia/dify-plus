...
import { LicenseStatus, type SystemFeatures } from '@/types/feature' // extend：加上 type SystemFeatures
import Toast from '@/app/components/base/toast'
import { IS_CE_EDITION, API_PREFIX } from '@/config'
